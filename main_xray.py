...
if args.model == 'MVFA':
    ...
    path_save = r'./Results/XRay/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_save = r'./Results/XRay/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/XRay/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/XRay/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/XRay/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/XRay/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
