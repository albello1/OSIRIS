...
class SSHIBA(object):    
    ...
    def __init__(self, Kc = 2, prune = 1, fs = 0, SS_sep = 0,  hyper = None, X_init = None, 
    ...
    def fit_iterate(self, max_iter = 250, pruning_crit = 1e-3, tol = 1e-8, feat_crit = 1e-3, perc = False, verbose = 0, Y_tst = [None], 
