...
# =================================================== #
folds_file = '/export/usuarios01/abelenguer/Datos/OSIRIS_exps/Fashiongen/'+str(folds)+'folds_'+database+'.p'
...
path_save = r'./Results/Imputation/Fashion/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'_'+str(args.perc)+'_'+str(args.imputer)+'.npy'
