...
if args.model == 'MVFA':
    ...
    path_save = r'./Results/Scene15/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_save = r'./Results/Scene15/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Scene15/MKL_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Scene15/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Scene15/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Scene15/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Scene15/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Scene15/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
