...
def save_data_mat(X_train, X_test, Y_train, Y_test, file_name):
    ...
    savemat('./TMC_temporal/'+file_name, datos)
...
if args.model == 'MVFA':
    ...
    path_save = r'./Results/Fashion/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_save = r'./Results/Fashion/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Fashion/MKL_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Fashion/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Fashion/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Fashion/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Fashion/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Fashion/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)