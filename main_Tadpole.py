...
if args.model == 'MVFA':
    ...
    path_save = r'./Results/Tadpole/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_save = r'./Results/Tadpole/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Tadpole/MKL_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Tadpole/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Tadpole/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/Tadpole/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Tadpole/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/Tadpole/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
