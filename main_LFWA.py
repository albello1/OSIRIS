...
if args.model == 'MVFA':
    ...
    path_save = r'./Results/LFWA/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_save = r'./Results/LFWA/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/LFWA/MKL_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/LFWA/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/LFWA/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    results = [soft, Y_tst]
    path_save = r'./Results/LFWA/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/LFWA/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
    ...
    path_save = r'./Results/LFWA/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_save, "wb") as a:
        pickle.dump(results, a)
