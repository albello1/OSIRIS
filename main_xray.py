...
X1 = np.load(r'./Data/XRay/X1.npy')
X2 = np.load(r'./Data/XRay/X2.npy')
Y = np.load(r'./Data/XRay/labels.npy')
...
folds = 10
folds_file = './Data/XRay/'+str(folds)+'folds_'+database+'.p'
...
if args.model == 'MVFA':
    ...
    path_guardar = r'./Results/XRay/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_guardar = r'./Results/XRay/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/XRay/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    results = [soft, Y_tst]
    path_guardar = r'./Results/XRay/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    results = [soft, Y_tst]
    path_guardar = r'./Results/XRay/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/XRay/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/XRay/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
