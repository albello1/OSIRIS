...
X1 = np.load(r'./Data/Digit/view1.npy')
X2 = np.load(r'./Data/Digit/view2.npy')
X3 = np.load(r'./Data/Digit/view3.npy')
X4 = np.load(r'./Data/Digit/view4.npy')
X5 = np.load(r'./Data/Digit/view5.npy')
X6 = np.load(r'./Data/Digit/view6.npy')
Y = np.load(r'./Data/Digit/labels.npy')
...
# =================================================== #
folds_file = './Data/Digit/'+str(folds)+'folds_'+database+'.p'
...
if args.model == 'MVFA':
    ...
    myModel.fit(X0_t,X1_t,X2_t,X3_t,X4_t,X5_t, Y1_tr, max_iter = 500, Y_tst = Y1_tst, AUC = 0, ACC = 0, verbose = 2)
    ...
    path_guardar = r'./Results/Digit/MVFA_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    ...
    path_guardar = r'./Results/Digit/PLS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/XRay/MKL_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/Digit/CPM_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    results = [soft, Y_tst]
    path_guardar = r'./Results/Digit/CSMVIB_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    results = [soft, Y_tst]
    path_guardar = r'./Results/Digit/TMC_'+str(args.fold)+'_'+str(args.seed)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/Digit/DeepIMV_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)
    ...
    path_guardar = r'./Results/Sat/OSIRIS_'+str(args.seed)+'_'+str(args.fold)+'.npy'
    with open(path_guardar, "wb") as archivo:
        pickle.dump(results, archivo)